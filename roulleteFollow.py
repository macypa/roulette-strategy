...
winningNumbers = numbers1st12 + numbers2nd12
losingNumbers = zero + numbers3rd12  
...
def updateStatistics():
	global redNumbersDrawn, blackNumbersDrawn, numbers1st12Drawn, numbers2nd12Drawn, numbers3rd12Drawn
	...
	if lastDraw in numbers1st12:
		numbers1st12Drawn += 1
	elif lastDraw in numbers2nd12:
		numbers2nd12Drawn += 1
	elif lastDraw in numbers3rd12:
		numbers3rd12Drawn += 1

def placeBet():
	global lastDraw, initBet, maxBet, bet, playOnWinOnly, placeNotOnLosingStreak, winningNumbers, losingNumbers, numbers1st12Drawn, numbers2nd12Drawn, numbers3rd12Drawn

	if numbers1st12Drawn > numbers2nd12Drawn+drawnDiff:
		if numbers1st12Drawn > numbers3rd12Drawn+drawnDiff:
			winningNumbers = numbers2nd12 + numbers3rd12
			losingNumbers = zero + numbers1st12
	elif numbers2nd12Drawn > numbers3rd12Drawn+drawnDiff:
		if numbers2nd12Drawn > numbers1st12Drawn+drawnDiff:
			winningNumbers = numbers3rd12 + numbers1st12
			losingNumbers = zero + numbers2nd12
	elif numbers3rd12Drawn > numbers1st12Drawn+drawnDiff:
		if numbers3rd12Drawn > numbers2nd12Drawn+drawnDiff:
			winningNumbers = numbers1st12 + numbers2nd12
			losingNumbers = zero + numbers3rd12
	else:
		bet = 0
	...
	# if lastDraw in numbers1st12:
	# 	winningNumbers = numbers1st12
	# 	losingNumbers = zero + numbers3rd12 + numbers2nd12
	# elif lastDraw in numbers2nd12:
	# 	winningNumbers = numbers2nd12
	# 	losingNumbers = zero + numbers1st12 + numbers3rd12
	# elif lastDraw in numbers3rd12:
	# 	winningNumbers = numbers3rd12
	# 	losingNumbers = zero + numbers2nd12 + numbers1st12
	# else:
	# 	bet = 0
	# 	return
...
def dump(drawNumber):
	...
	print "drawNumber: " + str(drawNumber) + ", lastDraw: " + str(lastDraw) + ", win: " + str(isWin()) + ", bet: " + str(bet) + ", profit: " + str(-bet if isWin() == False else round(bet*winRatioFromBet,1) if isWin() == True else round(bet*winRatioFroNeutralNumbers,1)) + ", deposit: " + str(deposit) + "  ..... redNumbersDrawn: " + str(redNumbersDrawn) + ", blackNumbersDrawn: " + str(blackNumbersDrawn) + ", numbers1st12Drawn: " + str(numbers1st12Drawn) + ", numbers2nd12Drawn: " + str(numbers2nd12Drawn) + ", numbers3rd12Drawn: " + str(numbers3rd12Drawn) 
