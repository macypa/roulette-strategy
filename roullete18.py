...
winningNumbers = numbers1to18
losingNumbers = zero + numbers19to36
...
def updateStatistics():
	...
	if lastDraw in numbers1to18:
		redNumbersDrawn += 1
	elif lastDraw in numbers19to36:
		blackNumbersDrawn += 1
...
def placeBet():
	...
	if redNumbersDrawn > blackNumbersDrawn+drawnDiff:
		winningNumbers = numbers19to36
		losingNumbers = zero + numbers1to18
