...
useBetSteps = False
betSteps = [1.7, 3.4, 5.1, 6.8, 8.5, 10.2, 11.9, 13.6, 15.3] # / (9x18, 8x1)
...
winRatioFromBet = 1.117
winRatioFroNeutralNumbers = 0.058
winAddFromBet = 0
...
winningNumbers = list(range(19, 27)) # 2
losingNumbers = list([0]) + list(range(27, 37)) # 2
