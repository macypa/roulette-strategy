...
useBetSteps = False
# betSteps = [0.6, 0.9, 1.2, 2.1, 3, 4.8, 7.2]
...
winRatioFromBet = 1.25
winRatioFroNeutralNumbers = 0.5
winAddFromBet = 0
...
winningNumbers = list([19, 20, 22, 23]) # 2
losingNumbers = list([0, 21, 24]) + list(range(25, 37)) # 2
