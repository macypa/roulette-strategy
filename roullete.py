...
numbers1in6 = list(range(1, 7))
numbers2in6 = list(range(7, 13))
numbers3in6 = list(range(13, 19))
numbers4in6 = list(range(19, 25))
numbers5in6 = list(range(25, 31))
numbers6in6 = list(range(31, 37))
...
# winningNumbers = numbers1to18 + numbers3rd12
# losingNumbers = zero + list(range(19, 25))

winningNumbers = numbers1to18 + numbers3rd12
losingNumbers = zero + numbers4in6
...
# winRatioFromBet = 0.25
# winRatioFroNeutralNumbers = 0.13
winRatioFromBet = 0.2
...
def placeBet():
	global playAfterTrigger, lastDraw, initBet, maxBet, bet, playOnWinOnly, placeNotOnLosingStreak, winningNumbers, losingNumbers, numbers1st12Drawn, numbers2nd12Drawn, numbers3rd12Drawn

	if playAfterTriggerInit > 0:
		playAfterTrigger -= 1
		if lastDraw in numbers4in6:
			playAfterTrigger = playAfterTriggerInit
		else:
			if playAfterTrigger <= 0:
				bet = 0
				return
